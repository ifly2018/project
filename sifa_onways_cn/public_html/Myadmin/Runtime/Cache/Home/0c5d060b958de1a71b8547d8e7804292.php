...
<div class="panel admin-panel">
    <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 修改文章</strong></div>
    <div class="body-content">

        <form method="post" class="form-x" action="/myadmin.php/Home/Article/save" enctype="multipart/form-data" >

            <div class="form-group">
                <div class="label"><label>分类：</label></div>
                <div class="field">
                    <select name="cate_id" class="input w50">
                        <?php if(is_array($category)): foreach($category as $key=>$cate): ?><option value="<?php echo ($cate["id"]); ?>"  <?php if($data['cate_id'] == $cate['id']): ?>selected<?php endif; ?> ><?php echo ($cate["html"]); echo ($cate["name"]); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field"> <input type="text" class="input" name="title" value="<?php echo ($data["title"]); ?>" /> </div>
            </div>

            <div class="form-group">
                <div class="label">  <label>内容：</label> </div>
                <div class="field">
                    <script id="editor" name="content" type="text/plain" style="width:100%;height:300px;"><?php echo ($data["content"]); ?></script>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group" id="thumb" <?php if($data["thumb"] == ''): ?>style="display: none;"<?php endif; ?>>
                    <div class="label"> <label></label> </div>
                    <div class="field"> <img src="<?php echo ($site_url); ?>/Uploads/image/<?php echo ($data["thumb"]); ?>" id="img0" style="width: 150px; height: auto;"> </div>
                </div>


            <div class="form-group">
                <div class="label"> <label>排序：</label> </div>
                <div class="field"> <input type="text" class="input w50" name="sort" value="<?php echo ($data["sort"]); ?>" /> </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <button class="button bg-main icon-check-square-o" type="submit">编 辑</button>
                </div>
            </div>
        </form>
    </div>
